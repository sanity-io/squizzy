...
3. Add your app domain to your Sanity project’s CORS settings. In the `/studio` folder, run `sanity cors add https://your-name.now.sh --credentials` or go to your project’s API settings on [manage.sanity.io](https://manage.sanity.studio)
